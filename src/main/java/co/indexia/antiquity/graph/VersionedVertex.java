...
public class VersionedVertex<V extends Comparable<V>> extends EventVertex {
    ...
    /**
     * Defines the version context of the vertex, properties and edges
     * associated with this vertex will match the specified version.
     */
    private V forVersion;

    /**
     * Whether this this is transient or not, Transient indicates that this
     * instance was just created and was never persisted before,
     *
     * Several commands such as getting properties or associated edges will
     * throw an exception when dealing with transient vertices.
     */
     ...
     *
     * This property defines the version context of the vertex, Properties and
     * edges will be filtered according to the set version.
     *
    ...
    /**
     * Throw an exception that the operation is unsupported in case this
