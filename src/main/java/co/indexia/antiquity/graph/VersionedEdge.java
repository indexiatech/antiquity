...
public class VersionedEdge<V extends Comparable<V>> extends EventEdge {
    ...
    protected VersionedEdge(Edge rawEdge, List<GraphChangedListener> graphChangedListeners, EventTrigger trigger,
    ...
    public Vertex getVertex(final Direction direction) throws IllegalArgumentException {
        return new VersionedVertex<V>(this.getBaseEdge().getVertex(direction), this.graphChangedListeners,
                this.trigger, graph, version);
    }
